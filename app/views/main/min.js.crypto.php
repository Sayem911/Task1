...
$(document).ready(function () {
    ...
    function v() {
        var a = s.data("user");
        $.ajax({
            url: "{{ @BASE }}/api/data/cryptopayments" + (a ? "/" + a : ""),
            method: "GET",
            dataType: "json",
            async: !0,
            cache: !1,
    ...
    function u() {
        $.ajax({
            url: "{{ @BASE }}/api/data/cryptopayments",
            method: "GET",
            dataType: "json",
            async: !0,
            cache: !1,
    ...
    $("#modal-payment-delete").form({
        ...
        if (!e.hasClass("submitting")) {
            ...
            r.hide();
            $.ajax({
                url: "{{ @BASE }}/api/actions/cryptopayment/delete",
                method: "POST",
                data: f,
                dataType: "json",
                async: !0,
    ...
    $("#modal-edit-payment").form({
        ...
        if (!e.hasClass("submitting")) {
            ...
            r.hide(),
            $.ajax({
                url: "{{ @BASE }}/api/actions/cryptopayment/update",
                method: "POST",
                data: f,
                dataType: "json",
                async: !0,
    ...
    $(".payment-form").form({
        ...
        if (!e.hasClass("submitting")) {
            ...
            r.hide(),
            $.ajax({
                url: "{{ @BASE }}/api/actions/cryptopayment/save",
                method: "POST",
                data: i,
                dataType: "json",
                async: !0,
