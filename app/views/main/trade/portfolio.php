      ...
      <div id="tab-trades" class="ui tab" data-tab="tab-trades">
        ...
        <table id="trades-list" class="ui sortable celled {{ @SITE.MAIN_COLOR }} table">
          ...
          <tr>
            ...
            <th class="center aligned" style="display: none;">{{ @portfolio.trades.startdate }}</th>
            <th class="center aligned">{{ @portfolio.trades.enddate }}</th>
            <th class="center aligned" style="display: none;">{{ @portfolio.trades.duration }}</th>
      ...
      <div id="tab-fonds" class="ui tab" data-tab="tab-fonds">
        <check if="{{ @USER.is_admin }}">
            <form id="modal-add-fonds" name="fonds-form" class="ui fonds-form skip-submission-check form small action modal" method="post">
                ...
                <div class="content">
                    ...
                    <div class="required field">
                      <div class="ui left labeled input right input">
                        <div class="ui label">{{ @portfolio.fonds.issuer }}</div>
                        <input type="text" tabindex="0" name="issuer" value="" placeholder="{{ @portfolio.fonds.issuer }}" />
                      </div>
                    </div>
                    <div class="required field">
                      <div class="ui left labeled input right input">
                        <div class="ui label">{{ @portfolio.fonds.domicile }}</div>
                        <input type="text" name="domicile" value="" placeholder="{{ @portfolio.fonds.domicile }}" />
                      </div>
                    </div>
                    <div class="field">
                      <div class="ui left labeled input right icon focus">
                        <div class="ui label">{{ @portfolio.fonds.current_value }}</div>
                        <input type="text" name="current_value"  value="" placeholder="{{ @portfolio.fonds.current_value }}" />
                        <i class="euro icon"></i>
                      </div>
                    </div>
                    <div class="field">
                      <div class="ui left labeled input right icon">
                        <div class="ui label">{{ @portfolio.fonds.origin_value }} in <br>{{ @USER.currency }}</div>
                        <input type="text" name="origin_value" value="" placeholder="{{ @portfolio.fonds.origin_value }}" />
                        <i class="euro icon"></i>
                      </div>
                    </div>
                    <div class="required field">
                      <div class="ui left labeled input right icon">
                        <div class="ui label">{{ @portfolio.fonds.profit_loss }}</div>
                        <i class="euro icon"></i>
                        <input type="text" name="profit_loss" value="" placeholder="{{ @portfolio.fonds.profit_loss }}" />
                      </div>
                    </div>
                    <div class="required field">
                      <div class="ui left labeled input right icon">
                        <div class="ui label">{{ @portfolio.fonds.roi }}</div>
                        <i class="percent icon"></i>
                        <input type="text" name="roi" value="" placeholder="{{ @portfolio.fonds.roi }}" />
                      </div>
                    </div>
                    <div class="field">
            ...
            <div class="ui stackable grid">
                <div class="four column row">
                    <div class="center aligned column">
                        <div class="ui fluid fonds user search" data-callback="refreshFondsList" data-user="{{ @USER.id }}">
                            <div class="ui icon input">
                                <input class="prompt" type="text" value="{{ @USER.first_name.' '.@USER.last_name }}" />
                                <i class="user icon"></i>
                            </div>
        ...
        <table id="fonds-list" class="ui sortable celled {{ @SITE.MAIN_COLOR }} table">
          ...
          <tr>
            ...
            <th class="center aligned">{{ @portfolio.fonds.issuer }}</th>
            <th class="center aligned">{{ @portfolio.fonds.domicile }}</th>
            <th class="center aligned">{{ @portfolio.fonds.current_value }} in <br>{{ @USER.currency }}</th>
            <th class="center aligned">{{ @portfolio.fonds.origin_value }} in <br>{{ @USER.currency }}</th>
            <th class="center aligned">{{ @portfolio.fonds.profit_loss }}</th>
            <th class="center aligned">{{ @portfolio.fonds.roi }}</th>
            <check if="{{ @USER.is_admin }}"><th class="center aligned"></th></check>
          </tr>
          </thead>
          <tbody>
        ...
        <check if="{{ @USER.is_admin }}">
            <form id="modal-add-fixed-deposit" name="add-fixed-deposit-form" class="ui add-fixed-deposit-form skip-submission-check form small action modal" method="post">
                ...
                <div class="content">
                    ...
                    <div class="field">
                      <div class="ui left labeled input right icon">
                        <div class="ui label">{{ @portfolio.fixed_deposit.notes }}</div>
                        <input type="text" name="notes" value="" placeholder="{{ @portfolio.fixed_deposit.notes }}" />
                        <i class="text icon"></i>
                      </div>
                    </div>
                    <!--
            ...
            <table id="fixed-deposit-list" class="ui sortable celled {{ @SITE.MAIN_COLOR }} table">
              ...
              <tr>
                ...
                <th class="center aligned">{{ @portfolio.fixed_deposit.notes }} </th>
                <!--
