                          ...
                          <table border="0" cellpadding="30" cellspacing="0" width="100%">
                            <tr>
                              <td align="center" valign="top" class="textContent">
                                <a href="{{ Helper::baseUrl() }}" target="_blank"><img src="{{ Helper::baseUrl() }}assets/images/logo-white.png"></a>
                                  ...
                                  <tr>
                                    <td align="left" class="textContent">
                                      <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                        {{ @email.signup.hello,@vars.first_name | format }}
                                      </h3>
                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        {{ @email.signup.text }} {{ @website.title }}
                                      </div>
                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        {{ @email.signup.text1 }}
                                      </div>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                            <tr>
                              <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="{{ @vars.password_reset_url }}" target="_blank">
                                  ...
                                  <tr>
                                    <td valign="top" class="textContent">
                                      ...
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        {{ @email.signup.text4,Helper::formatNumber(@TRADE.INITIAL_BALANCE),@TRADE.ACCOUNT_CURRENCY | format }}
                                      </div>
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        {{ @email.signup.text5 }}
                                      </div>
                                      ...
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        {{ @email.signup.text7 }} {{ @website.title }}
                                      </div>
                                    </td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              <td valign="top" bgcolor="#E1E1E1">
                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                  <div>{{ @email.general.copy }} &copy; {{ date('Y') }} <a href="{{ Helper::baseUrl() }}" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">{{ @website.title }}</span></a>. {{ @email.general.rights }}</div>
                                </div>
                              </td>
                            </tr>
                          </table>
