...
$(document).ready(function () {
        ...
        var F = {
            apiSettings: {
                url: "<?php echo $BASE; ?>/api/search/asset/{query}"
            },
            cache: !1,
            error: {
                noResults: "<?php echo $trade['symbol']['search']['no_results']; ?>"
            },
            type: "stocks",
            templates: {
                stocks: n
        ...
        function e(e, t) {
            ...
            a(),
            e.watched > 0 ? $(".add-to-watchlist").removeClass("basic loading disabled").addClass("watching").html('<i class="star icon"></i> <?php echo $trade['symbol']['watching']; ?>') : $(".add-to-watchlist").removeClass("loading disabled watching").addClass("basic").html('<i class="star icon"></i> <?php echo $trade['symbol']['watch']; ?>'),
            getLiveQuotes(),
            u(),
            c()
        }
        function a() {
            $.ajax({
                url: "<?php echo $BASE; ?>/api/actions/symbol/set/" + b,
                dataType: "json",
                async: !0,
                cache: !1
            })
        ...
        $(".add-to-watchlist").on("click", function () {
            ...
            if (!e.hasClass("disabled")) {
                ...
                $.ajax({
                    url: "<?php echo $BASE; ?>/api/actions/watchlist/" + a + "/" + b,
                    dataType: "json",
                    async: !0,
                    cache: !1,
                    success: function (t) {
                        t && t.success ? "add" == a ? (e.removeClass("basic loading disabled").addClass("watching"), e.html('<i class="star icon"></i> <?php echo $trade['symbol']['watching']; ?>')) : "remove" == a && (e.removeClass("loading disabled watching").addClass("basic"), e.html('<i class="star icon"></i> <?php echo $trade['symbol']['watch']; ?>')) : e.removeClass("loading disabled")
                    },
                    error: handleAjaxError
                })
            }
        ...
        var q = {
            ...
            panels: [{
                    showCategoryAxis: !0,
                    title: "<?php echo $trade['chart']['title']['price']; ?>",
                    percentHeight: 70,
                    precision: 2,
                    ...
                    title: "<?php echo $trade['chart']['title']['volume']; ?>",
                    percentHeight: 30,
                    precision: 0,
                    stockGraphs: [{
                            valueField: "volume",
            ...
            periodSelector: {
                ...
                periods: [{
                        period: "MM",
                        count: 1,
                        label: "<?php echo $trade['chart']['periods']['0']; ?>",
                        selected: !0
                    }, {
                        period: "MM",
                        count: 3,
                        label: "<?php echo $trade['chart']['periods']['1']; ?>",
                        selected: !0
                    }, {
                        period: "MM",
                        count: 6,
                        label: "<?php echo $trade['chart']['periods']['2']; ?>",
                        selected: !0
                    }, {
                        period: "YTD",
                        label: "<?php echo $trade['chart']['periods']['3']; ?>"
                    }, {
                        period: "YYYY",
                        count: 1,
                        label: "<?php echo $trade['chart']['periods']['4']; ?>"
                    }, {
                        period: "YYYY",
                        count: 3,
                        label: "<?php echo $trade['chart']['periods']['5']; ?>"
                    }, {
                        period: "MAX",
                        label: "<?php echo $trade['chart']['periods']['6']; ?>"
                    }
                ]
            },
            dataSetSelector: {
        ...
        A.form({
            ...
            fields: {
                quantity: {
                    rules: [{
                            type: "empty",
                            prompt: "<?php echo $trade['form']['quantity']['error']; ?>"
                        }, {
                            type: "integer",
                            prompt: "<?php echo $trade['form']['quantity']['error']; ?>"
                        }
        ...
        $("button.trade").on("click", function () {
            ...
            if (!e.hasClass("disabled") && A.form("is valid")) {
                ...
                $.ajax({
                    url: "<?php echo $BASE; ?>/api/actions/trade",
                    method: "POST",
                    data: {
                        symbol: b,
                        quantity: s,
                    ...
                    success: function (e) {
                        ...
                        e && e.success ? (o || $("#user-balance").text(e.balance.formatNumber() + " <?php echo $USER['currency']; ?>").transition("flash"), t.find(".header").text("<?php echo $trade['form']['trade']['success']['title']; ?>"), t.removeClass("error").addClass("success")) : (t.find(".header").text("<?php echo $trade['form']['trade']['failure']; ?>"), t.removeClass("success").addClass("error")),
        ...
        $("div.stock-edit").on("click", function () {
            ...
            y.dropdown(),
            $.ajax({
                url: "<?php echo $BASE; ?>/api/data/market/all",
                method: "GET",
                dataType: "json",
                async: !0,
                cache: !1,
                success: function (d) {
                    ...
                    y.dropdown({'values': w,});
                    $.ajax({
                        url: "<?php echo $BASE; ?>/api/data/asset/info/"+s.val(),
                        method: "GET",
                        dataType: "json",
                        async: !0,
                        cache: !1,
        ...
        $("#modal-stock-add").form().on("submit", function (a) {
            ...
            if (!e.hasClass("submitting")) {
                ...
                $.ajax({
                    url: "<?php echo $BASE; ?>/api/actions/asset/add",
                    method: "POST",
                    data: i,
                    dataType: "json",
                    async: !0,
        ...
        $("#modal-stock-edit").form().on("submit", function (a) {
            ...
            if (!e.hasClass("submitting")) {
                ...
                $.ajax({
                    url: "<?php echo $BASE; ?>/api/actions/asset/update",
                    method: "POST",
                    data: i,
                    dataType: "json",
                    async: !0,
        ...
        $("#modal-stock-delete").form().on("submit", function (a) {
            ...
            if (!e.hasClass("submitting")) {
                ...
                $.ajax({
                    url: "<?php echo $BASE; ?>/api/actions/asset/delete",
                    method: "POST",
                    data: i,
                    dataType: "json",
                    async: !0,
