                          ...
                          <table border="0" cellpadding="30" cellspacing="0" width="100%">
                            <tr>
                              <td align="center" valign="top" class="textContent">
                                <a href="<?php echo Helper::baseUrl(); ?>" target="_blank"><img src="<?php echo Helper::baseUrl(); ?>assets/images/logo-white.png"></a>
                                <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-top:10px;margin-bottom:10px;text-align:center;">
                                  ...
                                  <tr>
                                    <td align="left" class="textContent">
                                      <h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                        <?php echo \Base::instance()->format($email['signup']['hello'],$vars['first_name']); ?>
                                      </h3>
                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text']; ?> <?php echo $website['title']; ?>
                                      </div>
                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text1']; ?>
                                      </div>
                                      <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text2']; ?>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
                          ...
                          <table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
                            <tr>
                              <td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="<?php echo $vars['password_reset_url']; ?>" target="_blank">
                                  <?php echo $email['signup']['confirm']; ?>
                                </a>
                              </td>
                            </tr>
                          </table>
                                  ...
                                  <tr>
                                    <td valign="top" class="textContent">
                                      ...
                                      <h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">
                                        <?php echo $email['signup']['text3']; ?>
                                      </h3>
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo \Base::instance()->format($email['signup']['text4'],Helper::formatNumber($TRADE['INITIAL_BALANCE']),$TRADE['ACCOUNT_CURRENCY']); ?>
                                      </div>
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text5']; ?>
                                      </div>
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text6']; ?>
                                      </div>
                                      <div mc:edit="body" style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;margin-bottom:3px;">
                                        <?php echo $email['signup']['text7']; ?> <?php echo $website['title']; ?>
                                      </div>
                                    </td>
                                  </tr>
                                </table>
                            ...
                            <tr>
                              <td valign="top" bgcolor="#E1E1E1">
                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                  <div><?php echo $email['general']['copy']; ?> &copy; <?php echo date('Y'); ?> <a href="<?php echo Helper::baseUrl(); ?>" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;"><?php echo $website['title']; ?></span></a>. <?php echo $email['general']['rights']; ?></div>
                                </div>
                              </td>
                            </tr>
                          </table>
