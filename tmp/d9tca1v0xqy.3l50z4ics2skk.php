    ...
    <div class="left aligned sixteen wide column">
        <div class="column">
            <div class="ui piled segment">
              <span class="ui <?php echo $SITE['MAIN_COLOR']; ?> ribbon label"><i class="line chart icon"></i> <?php echo $website['menu']['markets']; ?></span>
              <span><?php echo $portfolio['markets']['title1']; ?></span>
...
<!-- TradingView Widget END --></p>
    ...
    <div class="left aligned sixteen wide column">
        <div class="column">
            <div class="ui piled segment">
              <span class="ui <?php echo $SITE['MAIN_COLOR']; ?> ribbon label"><?php echo $website['menu']['markets']; ?></span>
              <span><?php echo $portfolio['markets']['title1']; ?></span>
              <p><!-- TradingView Widget BEGIN -->
<div class="tradingview-widget-container">
  <div class="tradingview-widget-container__widget"></div>
