...
<link rel="apple-touch-icon" sizes="57x57" href="<?php echo $BASE; ?>/assets/images/icons/apple-touch-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?php echo $BASE; ?>/assets/images/icons/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?php echo $BASE; ?>/assets/images/icons/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo $BASE; ?>/assets/images/icons/apple-touch-icon-76x76.png">
