<div class="ui middle aligned center aligned grid centered-container">
  <div class="column">
    <form id="form-login" class="ui large form" method="POST" action="<?php echo $BASE; ?><?php echo $PATH; ?>">
      <div class="ui stacked segment">
        <h2 class="ui <?php echo $SITE['MAIN_COLOR']; ?> image header">
          <center><a class="ui image" style="background-color: rgb(46,142,248);padding-top: 4px;" href="<?php echo $BASE; ?>/"><img src="<?php echo $BASE; ?>/assets/images/logo-myecovest.svg" style="max-width: 80%;"></a></center>
          <div class="content">
