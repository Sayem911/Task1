<div class="ui container">
  <div class="ui stackable one column grid">
    ...
    <div class="ui piled segment">
      <span class="ui <?php echo $SITE['MAIN_COLOR']; ?> ribbon label"><i class="money icon"></i> <?php echo $title['trade']; ?></span>
      </span>
      </div>
      ...
      <div class="ui stackable grid">
        <div class="eight wide column">
            <form id="modal-limit-order" name="limit-order-form" class="ui limit-order-form skip-submission-check tiny form action modal" data-action="add">
                ...
                <div class="header">
                  <?php echo $signals['add']['title']; ?>

                </div>
                <div class="ui piled segment">
                    <div class="ui stackable two column grid">
                        <div class="column">
                            <div class="item"><span class=" value live-data selected-symbol" data-symbol="<?php echo $vars['symbol']; ?>" data-field="quoteType" data-format="fmtString"></span><span class="dot"></span><span class="symbol value"><?php echo $vars['symbol']; ?></span></div>
                            <div class="item header"><span class="short-name live-data selected-symbol" data-symbol="<?php echo $vars['symbol']; ?>" data-field="shortName"></span></div>
                            <div class="item"><span class="stock-exchange-name ui header"><i class="<?php echo $vars['asset']['exchange_country_code']; ?> flag"></i><?php echo $vars['asset']['exchange_name']; ?></span></div>
                        </div>
                        <div class="column right aligned">
                            <div class="item"><span class="live-data selected-symbol" data-symbol="<?php echo $vars['symbol']; ?>" data-format="fmtDate" data-field="regularMarketTime"></span></div>
                            ...
                            <div class="item"><span class=" value live-data selected-symbol" data-symbol="<?php echo $vars['symbol']; ?>" data-field="regularMarketChangePercent" data-format="fmtUpDownIndicatorWithPercent" data-format-args="regularMarketChange,regularMarketChangePercent"></span></div>
                        </div>
                    </div>
                </div>
                <div class="content">
                    ...
                    <div class="two fields">
                        <div class="field">
                            <div class="ui input select">
                        		...
                        		<label class="buy" for="type-buy"><?php echo $signals['add']['buy']; ?></label>
                        		<input class="sell" type="radio" id="type-sell" name="order_type" value="sell" />
                        		<label class="sell" for="type-sell"><?php echo $signals['add']['sell']; ?></label>
                            </div>                 
                        </div>
                        <div class="required field">
                          <div class="ui input">
                            <div class="ui ordertime-type fluid selection dropdown" tabindex="0">
                                ...
                                <div class="default text"><?php echo $signals['ordertime_type']['title']; ?></div>
                                <div class="menu">
                                    <div class="item" data-value="d"><?php echo $signals['ordertime_type']['forday']; ?></div>
                                    <div class="item" data-value="u"><?php echo $signals['ordertime_type']['unlimited']; ?></div>
                                </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="two fields">
                        <div class="required field">
                          <div class="ui input">
                            <div class="ui limit-type fluid selection dropdown" tabindex="0">
                                ...
                                <div class="menu">
                                    <div class="item" data-value="0"><?php echo $signals['limit_price']['title']; ?></div>
                                    <div class="item" data-value="1"><?php echo $signals['market_price']['title']; ?></div>
                                    <div class="item" data-value="2"><?php echo $signals['stop_loss']['title']; ?></div>
                                    <div class="item" data-value="3"><?php echo $signals['stop_limit']['title']; ?></div>
                                </div>
                            </div>
                          </div>
                        </div>
                        <div class="limit-entries required field">
                          <div class="ui limit-price input right icon">
                            <input type="text" tabindex="0" name="limit_price" value="" placeholder="<?php echo $signals['limit_price']['placeholder']; ?>" />
                            <i class="euro icon"></i>
                          </div>
                          <div class="ui stop-price input right icon">
                            <input type="text" tabindex="0" name="stop_price" value="" placeholder="<?php echo $signals['stop_price']['placeholder']; ?>" />
                            <i class="euro icon"></i>
                          </div>
                          <div class="ui market-amount input">
                            <input type="text" tabindex="0" name="market_amount" value="" placeholder="<?php echo $signals['amount']['placeholder']; ?>" />
                          </div>
                        </div>
                    </div>
                    <div class="two fields">
                        <div class="required field">
                          <div class="ui limit-amount input">
                            <input type="text" tabindex="0" name="limit_amount" value="" placeholder="<?php echo $signals['amount']['placeholder']; ?>" />
                          </div>
                        </div>
                        <div class="required field">
                          <div class="ui total input right icon">
                            <input type="text" tabindex="0" name="total" value="" placeholder="<?php echo $signals['total']['placeholder']; ?>" />
                            <i class="euro icon"></i>
                          </div>
                        </div>
                    </div>
                ...
                <div class="actions">
                    <div class="ui large left labeled icon cancel button left floated"><i class="cancel icon"></i> <?php echo $settings['form']['cancel']; ?> </i></div>
        ...
        <div class="eight wide right aligned column">
            <?php if ($USER['is_admin']): ?>
                    <div class="ui stock-op blue floating dropdown icon button">
                        <div class="text"><?php echo $trade['assets']['options']; ?> &nbsp;</div>
                        <i class="angle down icon"></i>
                        <div class="ui menu">
                          <div class="item stock-add"><i class="add icon"></i> <?php echo $trade['assets']['add']; ?></div>
                          <div class="item stock-edit"><i class="pencil icon"></i> <?php echo $trade['assets']['edit']; ?></div>
                          <div class="item stock-delete"><i class="trash icon"></i> <?php echo $trade['assets']['delete']; ?></div>
                        </div>
                    </div>
            <?php endif; ?>
        </div>
        <div class="center aligned sixteen wide column">
          ...
          <?php if (Helper::isDateTimeBetweenAndWorking($vars['asset']['trading_start'], $vars['asset']['trading_end'], $vars['asset']['exchange_timezone'])): ?>
            
              <span class="positive ui button"><?php echo $markets['exchange']['open']; ?></span>
            
            <?php else: ?>
              <span class="negative ui button"><?php echo $markets['exchange']['closed']; ?></span>
        ...
        <div class="center aligned sixteen wide column">
          <div id="market-closed">
            <div class="ui icon <?php echo $SITE['MAIN_COLOR']; ?> message">
              <i class="notched circle loading icon"></i>
              <div class="content">
                <div class="header">
                  <?php echo $trade['symbol']['disabled']['header']; ?>

                </div>
                <p><?php echo $trade['symbol']['disabled']['message']; ?></p>
              </div>
            </div>
          </div>
          <div id="trade-form" class="ui form">
            <div class="fields">
              <div class="two wide trade-quantity field">
                <input id="trade-quantity" name="quantity" placeholder="<?php echo $trade['symbol']['qty']['placeholder']; ?>" type="text">
              </div>
            </div>
            <div class="ui big buttons">
              <button class="ui positive left labeled icon trade button" data-action="buy"><i class="money icon"></i> <?php echo $trade['symbol']['buy']; ?></button>
              <div class="or"></div>
              <button class="ui negative trade button" data-action="sell"><?php echo $trade['symbol']['sell']; ?></button>
              <div class="or"></div>
              <button class="ui blue right labeled icon limit-order button"><?php echo $trade['limit_order']['button']; ?><i class="bell icon"></i></button>
        ...
        <?php if ($USER['is_admin']): ?>
          ...
          <div class="column">
            <div id="user-search" class="ui fluid user search">
              <div class="ui icon input">
                <input class="prompt" type="text" placeholder="<?php echo $trade['user']['search']['placeholder']; ?>">
                <i class="user icon"></i>
              </div>
              <div class="results"></div>
            </div>
        ...
        <div class="eight wide centered center aligned column">
          ...
          <div class="ui active tab" data-tab="tab-market-data">
            <table id="stock-market-data" class="ui sortable celled blue <?php echo $SITE['MAIN_COLOR']; ?> table">
              <tbody>
                <tr>
...
<?php if ($USER['is_admin']): ?>
    <form id="modal-stock-add" name="stock-form" class="ui stock-form skip-submission-check form small action modal" method="post">
        <i class="close icon"></i>
        <div class="header">
          <?php echo $trade['assets']['add_title']; ?>
        ...
        <div class="content">
            ...
            <div class="required field">
              <div class="ui left labeled input right input">
                <div class="ui label"><?php echo $trade['assets']['market_name']; ?></div>
                    <div class="ui market-name fluid search selection dropdown" tabindex="-1">
                        <input type="hidden" name="market" />
                        <i class="dropdown icon"></i>
                        <div class="default text"><?php echo $trade['assets']['market_name_placeholder']; ?></div>
                        <div class="menu"></div>
                    </div>
              </div>
            </div>
            <div class="required field">
              <div class="ui left labeled input right input">
                <div class="ui label"><?php echo $trade['assets']['asset_symbol']; ?></div>
                <input type="text" tabindex="0" name="symbol" value="" placeholder="<?php echo $trade['assets']['asset_symbol_placeholder']; ?>" />
              </div>
            </div>
            <div class="required field">
              <div class="ui left labeled input right icon">
                <div class="ui label"><?php echo $trade['assets']['asset_name']; ?></div>
                <input type="text" name="name" value="" placeholder="<?php echo $trade['assets']['asset_name_placeholder']; ?>" />
              </div>
            </div>
            <div class="field">
              <div class="ui left labeled input right icon focus">
                <div class="ui label"><?php echo $trade['assets']['asset_currency']; ?></div>
                <input type="text" name="currency" value="" placeholder="<?php echo $trade['assets']['asset_currency_placeholder']; ?>" />
                <i class="money bill alternate outline icon"></i>
              </div>
            </div>
            <div class="field">
              <div class="ui left labeled input right focus">
                <div class="ui label"><?php echo $trade['assets']['asset_nominal']; ?></div>
                <input type="text" name="nominal" value="" placeholder="<?php echo $trade['assets']['asset_nominal_placeholder']; ?>" />
              </div>
            </div>
        </div>
        <div class="actions">
    ...
    <form id="modal-stock-edit" name="stock-form" class="ui stock-form skip-submission-check form small action modal" post="/api/actions/stock/edit" method="post">
        <i class="close icon"></i>
        <div class="header">
          <?php echo $trade['assets']['edit_title']; ?>
    ...
    <form id="modal-stock-delete" class="ui skip-submission-check form small action modal" data-action="delete">
        ...
        <i class="close icon"></i>
        <div class="header">
          <?php echo $trade['assets']['delete_title']; ?>

        </div>
        <div class="content">
            <div class="ui error message"></div>
            <div class="ui result message"></div>
            <p><?php echo $trade['assets']['delete_description']; ?></p>
        </div>
        <div class="actions">
