    ...
    <form id="form-login" class="ui large form" style="opacity:65%;" method="POST" action="<?php echo $BASE; ?><?php echo $PATH; ?>">
      <div class="ui stacked segment">
        <h2 class="ui <?php echo $SITE['MAIN_COLOR']; ?> image header">
          <center><a class="ui image" style="background-color: rgb(255,255,255);padding-top: 4px;" href="<?php echo $BASE; ?>/"><img src="<?php echo $BASE; ?>/assets/images/alpen_invest-logo.png" style="max-width: 80%;"></a></center>
